...
|---|---|---|
| [2.5D camera (`?camera=3d`)](2.5d-camera-plan.md) | feature-complete, polish open | Garnish cards for 15 of 20 boards; higher-resolution backdrops (the one measured art win — §10 of that plan, row 4b above); a Settings toggle |
