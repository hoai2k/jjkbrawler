...
Round 15 is the first round that is not about fighters at all: **summons now
...
twelve new creatures that are live in play today wearing borrowed art.
...
canonical reference: 15A matches the existing still, and 15B is new design.)
...
- **15A** — the six-pose animation set for the five summons already delivered
  (30 sprites)
- **15B** — twelve new creatures, six poses each (72 sprites)
...
## 15A. Animation frames for the five delivered summons — 30 sprites
...
## 15B. Twelve new creatures — 72 sprites
...
## Integrating a round-15 delivery
