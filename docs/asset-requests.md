...
- **11B** — finish the semantic sets for the 5 fighters still on sheet cells (90 sprites)
...
**115 sprites left.** 11B is the bulk of it and the one that changes how the
roster reads: five fighters still play a sprint frame for a punch. 11C is the
...
integrated. **Geto, Hakari, Hanami, Inumaki, Jogo, Maki, Megumi and Momo are
done in 11B**, which is why the count moved from thirteen fighters to five. Their sections below are struck through rather
...
## 11B. Finish the semantic sets — 90 sprites across 5 fighters
...
(17) and Momo (18) have since been delivered and integrated** — all eight are
re-pointed and off this list. The remaining five still run on **4×5 sprite
...
## 12B. The four-frame run cycle — 92 sprites across 23 fighters
...
All 23 roster fighters, four poses each. Mahoraga is **not** in this list —
his cycle is part of the 11A redraw, which now asks for these four poses
directly instead of the old pair.
