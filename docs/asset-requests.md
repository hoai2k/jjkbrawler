...
- **9E** — redraw Gakuganji, Reggie and Uro from the anime reference; their current art is the wrong character (93 sprites + 3 cards). **Gakuganji's and Reggie's 31 poses are each delivered and in game; both cards, and all of Uro, are outstanding.**
