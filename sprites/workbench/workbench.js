...
import {
  $, canvas, ctx, canvasCentreX, GROUND_Y, PLATFORM_W, platformX, BENCHMARK_INSET, CELL_W,
  EDITABLE, KIND_FIELDS, BOOLEAN_FIELDS, TEXT_FIELDS,
  STATE_ORDER, STATE_LABELS, stateLabel, stateRank,
  OTHER_KEY, OTHER_LABEL, ACTOR_KEYS, WB_FIGHTERS, isStaged,
  RECENT_KEY, RECENT_LABEL, FLAGGED_KEY, FLAGGED_LABEL,
  isOther, isActor, inRecent, inFlagged, inList,
  BACKGROUNDS, state,
} from "./bench_state.js";
import {
  VIEWS,
...
import { openSpritePicker, closeSpritePicker, closePickerMenu, closePickerPreview, initSpritePicker }
