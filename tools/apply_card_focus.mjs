...
//
//   node tools/apply_card_focus.mjs ~/Downloads/jjkbrawler-card-focus-2026-08-17.json
...
const SCHEMA = "jjkbrawler.card-focus";
...
// A card the roster no longer has is a stale export, not a new fighter: say so
// and drop it rather than writing a key nothing will ever read.
