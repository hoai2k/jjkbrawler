...
const ROWS = [
  ...
  // A stick in a CORNER throws the neutral attack angled 45 degrees, hitbox
  // and body together (fighter.js attackTilt). A cardinal direction still
  // picks the up or down attack, which are their own moves.
