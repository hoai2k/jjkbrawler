...
//
// Seven creatures say exactly that, and it is not a judgement about the design:
// their plates arrived as CONTACT SHEETS of six figures (tools/check_summon_plates.py),
// so the drawn rectangle is six creatures wide and measuring it would be
// nonsense. Those seven keep the old numbers until the art is one figure, and
// the pairs come out when it lands.
//
